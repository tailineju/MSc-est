...
pacman::p_load(tidyverse, knitr, MASS, maxLik, VGAM)
...
ggplot(castor, aes(x = time)) +
  ...
  #add median and mean
  geom_vline(aes(xintercept = median(time), color = "Median"), size = 1) +
  geom_vline(aes(xintercept = mean(time), color = "Mean"), size = 1) +
  # add legend for median and mean
  scale_color_manual(name = "Statistics", values = c("Median" = "blue", "Mean" = "red")) +
  theme_article()
  #save as png
  ggsave("C:/Users/User/Documents/GitHub/MSc-est/MODELAGEM COM APOIO COMPUTACIONAL/article/final files/img/histogram_frequency.png", width = 8, height = 6)
...
ggplot(castor, aes(x = time_under_hydration, y = time)) +
  ...
  theme_article()
  ggsave("C:/Users/User/Documents/GitHub/MSc-est/MODELAGEM COM APOIO COMPUTACIONAL/article/final files/img/scatter_tuh.png", width = 8, height = 6)
```
...
ggplot(castor, aes(x = as.factor(temperature), y = time)) +
  ...
  theme_article()
  ggsave("C:/Users/User/Documents/GitHub/MSc-est/MODELAGEM COM APOIO COMPUTACIONAL/article/final files/img/boxplot_temperature.png", width = 8, height = 6)
...
ggplot(castor, aes(x = as.factor(puncture), y = time)) +
  ...
  theme_article()
  ggsave("C:/Users/User/Documents/GitHub/MSc-est/MODELAGEM COM APOIO COMPUTACIONAL/article/final files/img/boxplot_puncture.png", width = 8, height = 6)
```
